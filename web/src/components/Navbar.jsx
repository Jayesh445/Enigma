  ...
  return (
    <nav className=" sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4 w-screen">
          ...
          <div className="flex">
            <Link to="/login">
              <button className="flex items-center text-white  bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-700 hover:to-blue-800 px-4 py-2 rounded-md transition duration-300 ease-in-out">
                <Lock className="mr-3" />
                Login
              </button>
            </Link>
            <Link to="/signin">
              <button className="flex items-center text-white ml-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-700 hover:to-blue-800 px-4 py-2 rounded-md transition duration-300 ease-in-out">
                <Lock className="mr-3" />
                SignIn
              </button>
            </Link>
